...
LEXICON_PRICE: dict[str, str] = {
    ...
    'insta_info4_1': '<b>revizor_belarus.</b>\n'
                   '✅135 000 подписчиков.\n'
                   '✅100 000+ охват поста в ленте.\n'
                   '✅40 000+ просмотров видеоистории в сутки.\n'
                   '<a href="https://www.instagram.com/revizor_belarus/">www.instagram.com/revizor_belarus/</a>\n'
                   'Стоимость размещения:\n'
                   '💵Видеообзор(сторис 24 ч.) - 700 руб.\n'
                   '💵Пост(рилс) - 1000 руб.\n'
                   '💵Пост + Видеообзор - 1500 руб.\n',
